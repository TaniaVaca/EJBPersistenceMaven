package com.iatai.ejbpersistencemaven.utils.logger;

import com.iatai.ejbpersistencemaven.utils.properties.PropertiesFile;
...
public class Log {
	...
	static {
		try {
			PropertyConfigurator.configure(PropertiesFile.getProperties("com.iatai.ejebmyapppersistence.utils.logger.Log","log4j.properties"));
